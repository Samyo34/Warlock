    ...
    */
    class fireBall {
        constructor(parent, aimGoalPoint, damages, speed, range, action, actionTime, lifeTime) {
            ...
            this.orientation = Math.atan2(aimGoalPoint.y - parent.y, aimGoalPoint.x - parent.x);

            this.spdX = Math.cos(this.orientation) * speed;
            this.spdY = Math.sin(this.orientation) * speed;
        ...
        getUpdatePack() {
            ...
            console.log('Fireball ' + this.x + ' ' + this.y)
            ...
            valuesArray[5] = parseInt(this.orientation * 100000000);
        ...
        getInitPack() {
            console.log('Init pack Fireball ' + this.x + ' ' + this.y)
            return {
